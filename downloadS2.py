...
# Define Area of Interest (AOI) CHANGE ACCORDINGLY
...
# Define the time range for the images CHANGE ACCORDINGLY
...
copernicushub_config = data.create_configuration(client_id="YOUR_ID",  # Replace with your client ID 
    client_secret="YOUR_SECRET")  # Replace with your client secret
